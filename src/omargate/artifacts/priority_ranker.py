...
CATEGORIES: Dict[str, Dict[str, object]] = {
    "auth": {
        ...
        "commands": ['rg -n "password|credential|token|session" src/'],
    },
    "payment": {
        "icon": "💳",
        ...
        "commands": ['rg -n "stripe|payment|billing|charge" src/'],
    },
    "webhook": {
        "icon": "🔗",
        ...
        "commands": ['rg -n "webhook|signature|verify" src/'],
    },
    "database": {
        "icon": "🗄️",
        ...
        "commands": ['rg -n "query|sql|execute|rawQuery" src/'],
    },
    "crypto": {
        "icon": "🔑",
        "name": "Crypto & Secrets",
        ...
        "commands": ['rg -n "encrypt|decrypt|hash|sign" src/'],
    },
    "infrastructure": {
        "icon": "🔧",
